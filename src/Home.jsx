    ...
    <>
      ...
      <div className="flex flex-col ">
        ...
        <div className=" pl-5 md:pl-20 bg-[#000006] pt-20 h-screen translate-y-60 md:translate-y-0">
          <p className="text-white text-3xl  py-5 font-bold "> About Me </p>
          <p className="text-white ">
            {" "}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium
            at iure, voluptatum aperiam culpa adipisci debitis nulla modi nisi
            sunt unde. Quia pariatur ratione fugit commodi dolores nam
            asperiores esse omnis rem libero? Impedit placeat consectetur
            perspiciatis quos odit veniam labore. Nesciunt deserunt voluptate
            voluptatum, unde quisquam, doloremque pariatur accusantium ipsa
            rerum eveniet culpa officia fugiat mollitia in deleniti nobis
            molestias eius vero dolorum consectetur? Voluptas asperiores esse
            aliquid ea animi quaerat necessitatibus consectetur veniam nulla
            repellendus sint quae reprehenderit laudantium, autem qui a atque
            veritatis minus nihil iure quas id harum. Molestias quaerat
            praesentium consequuntur officiis facilis eligendi iusto.{" "}
          </p>
        </div>
      </div>
    </>
